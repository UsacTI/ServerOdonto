...
exports.login = (req, res) => {
  ...
  Paciente.findOne({
    ...
    if (results !== null) {
      ...
      paciente = { idpaciente: results.dataValues.idpaciente, usuario: results.dataValues.usuario, nombre: results.dataValues.nombres, apellidos: results.dataValues.apellidos }
    }
    // console.log(hash)
