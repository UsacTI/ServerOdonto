  ...
  try {
    ...
    if (!paciente) {
      ...
      const updatedObject = {
        ...
        escolaridad: (req.body.escolaridad === null ? 'primario' : req.body.escolaridad),
        nivel: (req.body.nivel === null ? '1' : req.body.nivel),
        profesion: (req.body.trauoficio === '' ? '' : req.body.trauoficio),
        transporte: (req.body.transporte === null ? 'otro' : req.body.transporte),
